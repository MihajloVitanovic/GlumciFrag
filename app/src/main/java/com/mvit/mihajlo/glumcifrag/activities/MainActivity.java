package com.mvit.mihajlo.glumcifrag.activities;
...
import com.mvit.mihajlo.glumcifrag.adapters.DrawerListAdapter;
...
import com.mvit.mihajlo.glumcifrag.dialogs.AboutDialog;
import com.mvit.mihajlo.glumcifrag.fragments.DetailFragment;
import com.mvit.mihajlo.glumcifrag.fragments.ListFragment;
import com.mvit.mihajlo.glumcifrag.model.NavigationItem;
import com.mvit.mihajlo.glumcifrag.fragments.ListFragment.OnProductSelectedListener;
...
public class MainActivity extends AppCompatActivity implements OnProductSelectedListener {
    ...
    private void addItem() throws SQLException {
        ...
        final EditText productLastName = (EditText) dialog.findViewById(R.id.product_lastName);
        final EditText productYearOfBirth = (EditText) dialog.findViewById(R.id.product_yearOfBirth);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String lastName = productLastName.getText().toString();
                String yearOfBirth = productYearOfBirth.getText().toString();
                ...
                product.setmLastName(lastName);
                product.setmYearOfBirth(yearOfBirth);
